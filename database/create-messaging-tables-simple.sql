-- Simple messaging tables without complex RLS policies
-- This will get basic functionality working first
...
-- Note: RLS is disabled for now to avoid policy issues
-- We can add security back later once basic functionality works
